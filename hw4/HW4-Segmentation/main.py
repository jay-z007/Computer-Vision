...
if __name__ == '__main__':
    ...
    mask = pixels_for_segment_selection(segments, np.nonzero(graph_cut))
    ...
    print RMSD(mask, cv2.imread("./example_output.png", cv2.IMREAD_GRAYSCALE))
    # ======================================== #
